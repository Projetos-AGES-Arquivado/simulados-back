...
public enum Exames {
    ...
    Exame7(
            7,
            "http://www.conteudojuridico.com.br/pdf/cj037552.pdf",
            "http://www.conteudojuridico.com.br/pdf/cj037552.pdf",
            "17/06/2012",
            1
    ),
    ...
    Exames (int numero, String urlExame, String urlGabarito, String data, int modelo) {
        try {
            SimpleDateFormat formatter = new SimpleDateFormat("dd/MM/yyyy");
            this.exame = new Exame(numero, new URL(urlExame), new URL(urlGabarito), formatter.parse(data), modelo);
        } catch (Exception e) {
